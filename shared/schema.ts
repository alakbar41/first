...
// Blockchain voter participation tracking (doesn't store who voted for whom, only tracks participation)
export const voteParticipation = pgTable("vote_participation", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").notNull(), // Reference to user id
  electionId: integer("election_id").notNull(), // Reference to election id
...
export type InsertVoteParticipation = z.infer<typeof insertVoteParticipationSchema>;
