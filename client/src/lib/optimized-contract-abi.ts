// ABI for the OptimizedVoting contract
export const OPTIMIZED_CONTRACT_ABI = [
  {
    "inputs": [],
  ...
  },
  {
    ...
    "outputs": [
      ...
      {
        "internalType": "enum OptimizedVoting.ElectionType",
        "name": "electionType",
        "type": "uint8"
      },
      {
        "internalType": "enum OptimizedVoting.ElectionStatus",
        "name": "status",
        "type": "uint8"
      },
      {
